 ...
 * validate can read the existing schema according to the default JSON schema
 * resolution rules.
 */
class ValidateCanRead implements SchemaValidationStrategy {
     ...
     * with the second schema, according to the default JSON schema resolution
     * rules.
     *
     * @throws SchemaValidationException if the first schema cannot read data written by the second.
     */
    @Override
