...
class ValidateCanBeRead implements SchemaValidationStrategy {
     ...
     * second schema, according to the default JSON schema resolution rules.
     *
     * @throws SchemaValidationException if the second schema cannot read data written by the first.
     */
    @Override
