...
import static io.yokota.json.diff.Difference.Type.DEFAULT_CHANGED;
...
import static io.yokota.json.diff.Difference.Type.DESCRIPTION_CHANGED;
...
import static io.yokota.json.diff.Difference.Type.ID_CHANGED;
...
import static io.yokota.json.diff.Difference.Type.SCHEMA_REMOVED;
import static io.yokota.json.diff.Difference.Type.SUM_TYPE_EXTENDED;
import static io.yokota.json.diff.Difference.Type.TITLE_CHANGED;
import static io.yokota.json.diff.Difference.Type.TYPE_CHANGED;
